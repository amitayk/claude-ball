...
export const catalog: CatalogEntry[] = [
  { name: "blitz", brain: blitz, skill: 100, blurb: "Keeper launches to a high striker; two pressers hunt." },
  { name: "chaser", brain: chaser, skill: 74, blurb: "Everyone chases the ball; whoever has it shoots." },
  { name: "formation", brain: formation, skill: 51, blurb: "Holds a 4-player shape; the nearest player presses." },
